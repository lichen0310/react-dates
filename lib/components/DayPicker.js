...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    }), verticalScrollable && this.renderNavigation()), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooter), _react["default"].createElement("p", (0, _extends2["default"])({}, this.props.startDate && (0, _moment["default"])(this.props.startDate._d).format('YYYY MM DD') === (0, _moment["default"])((0, _moment["default"])().subtract(13, 'days')._d).format('YYYY MM DD') && (0, _moment["default"])(this.props.endDate._d).format('YYYY MM DD') === (0, _moment["default"])().format('YYYY MM DD') ? _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterTextActive)) : _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText)), {
    ...
    }), "Last 14 days"), _react["default"].createElement("p", (0, _extends2["default"])({}, this.props.startDate && (0, _moment["default"])(this.props.startDate._d).format('YYYY MM DD') === (0, _moment["default"])((0, _moment["default"])().subtract(29, 'days')._d).format('YYYY MM DD') && (0, _moment["default"])(this.props.endDate._d).format('YYYY MM DD') === (0, _moment["default"])().format('YYYY MM DD') ? _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterTextActive)) : _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText)), {
      onClick: function onClick() {
        return _this6.props.onDatesChange({
    ...
    }), "Last 30 days"), _react["default"].createElement("p", (0, _extends2["default"])({}, this.props.startDate && (0, _moment["default"])(this.props.startDate._d).format('YYYY MM DD') === (0, _moment["default"])((0, _moment["default"])().subtract(59, 'days')._d).format('YYYY MM DD') && (0, _moment["default"])(this.props.endDate._d).format('YYYY MM DD') === (0, _moment["default"])().format('YYYY MM DD') ? _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterTextActive)) : _objectSpread({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText)), {
      onClick: function onClick() {
        return _this6.props.onDatesChange({
